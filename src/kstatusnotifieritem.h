 ...
 *
 * \brief %KDE StatusNotifierItem protocol implementation to create tray icons.
 *
 * This class implements the
 * <a href="https://www.freedesktop.org/wiki/Specifications/StatusNotifierItem/">
 * StatusNotifierItem D-Bus specification.</a>
 * It provides an icon similar to classical system tray icons,
 * with some key differences:
 *
 * - Its representation is done by the system tray (or the app behaving
 *   like it), not by the app that uses this API. Since version 4.5
 *   this also includes the menu, which means you cannot use embedded widgets
 *   in the menu.
 *
 * - The system tray and the icon owner communicate with one another, so the
 *   system tray can know if the application is in a normal or in a requesting
 *   attention state.
 *
 * - Icons are divided into categories, so the system tray can for example
 *   represent icons from normal applications and icons about hardware status
 *   differently.
 *
...
public:
     ...
     * This allows the application to signal to the system tray implementation
    ...
    /**
     * @brief Constructs a new StatusNotifierItem.
     *
    ...
    /**
     * @brief Constructs a new StatusNotifierItem with a unique identifier.
     *
     ...
     * A StatusNotifierItem without @p id defaults to the application's name
     * for the @p id.
     *
     * This id may be used, for instance, by hosts displaying StatusNotifierItems to
    ...
    /**
     * @brief The StatusNotifierItem's id.
     *
    ...
    /**
     * @brief Sets the category for the application.
     *
    ...
    /**
     * @brief Allows to access the context menu associated to the tray icon.
     *
