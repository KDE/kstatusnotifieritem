...
public:
    ...
    /*!
     * \brief Sets the main window associated with this StatusNotifierItem.
     *
    ...
    /*!
     * \brief Access the main window associated with this StatusNotifierItem.
     *
     * \since 6.0
     */
     ...
     *
     * \a timeout how much time will elaps before hiding the message
     */
